(function() {
  ...
  var _tmpl$$2 = /* @__PURE__ */ template(`<style>`), _tmpl$2 = /* @__PURE__ */ template(`<div class=input-response><span><slot name=children></slot></span><span>Input Response</span><span>Label: </span><input class=input-response__input>`);
  ...
  var _tmpl$$1 = /* @__PURE__ */ template(`<div><div></div><span><slot name=children></slot></span><acer-input-response label=Address:>`, true, false, false);
  const MultiResponseItem = (props) => {
    return (() => {
      var _el$ = _tmpl$$1(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$3.nextSibling;
  ...
  var _tmpl$ = /* @__PURE__ */ template(`<div><div></div><span><slot name=children></slot></span><acer-input-response>`, true, false, false);
  const SingleResponseItem = (props) => {
    return (() => {
  ...
  customElement("acer-single-response-item", {
    stem: ""
  }, SingleResponseItem);
})();
